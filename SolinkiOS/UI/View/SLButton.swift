    ...
    var body: some View {
        ...
        Button(action: {
            ...
            Image(systemName: "arrow.left")
                ...
                .foregroundColor(enabled ? (isPressed ? tint.opacity(0.7) : tint) : Color(UIColor(red: 0xB0/255, green: 0xBE/255, blue: 0xC5/255, alpha: 1))) // Corrected color
                .animation(.easeInOut, value: isPressed)
        }
        .frame(width: 48, height: 48)
        .background(enabled ? Color(UIColor(red: 0x02/255, green: 0x88/255, blue: 0xD1/255, alpha: 1)) : Color(UIColor(red: 0x01/255, green: 0x57/255, blue: 0x9B/255, alpha: 1))) // Corrected color
        .clipShape(Circle())
